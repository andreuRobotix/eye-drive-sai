...
if __name__ == "__main__":
    ...
    print(f"  learned gaze       : left={model.left:.2f}  center={model.center:.2f}  right={model.right:.2f}")
    print(f"  decision rule      : left if ratio>= {model.t_left:.2f}   right if ratio<= {model.t_right:.2f}")
